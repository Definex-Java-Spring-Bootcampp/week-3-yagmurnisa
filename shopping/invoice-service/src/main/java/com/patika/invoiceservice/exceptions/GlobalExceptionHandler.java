...
import com.patika.invoiceservice.exceptions.dto.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleCustomerException(InvoiceException exception) {
