...
import com.patika.productservice.exceptions.dto.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleCustomerException(ProductException exception) {
