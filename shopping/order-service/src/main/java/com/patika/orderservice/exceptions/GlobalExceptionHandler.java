...
import com.patika.orderservice.exceptions.dto.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleCustomerException(OrderException exception) {
